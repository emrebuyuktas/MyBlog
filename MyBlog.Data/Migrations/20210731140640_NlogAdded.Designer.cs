...
namespace MyBlog.Data.Migrations
{
    ...
    [Migration("20210731140640_NlogAdded")]
            ...
            modelBuilder.Entity("MyBlog.Entities.Concrete.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(1381),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(273),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(2025),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3319),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3317),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3321),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3328),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3326),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3329),
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3336),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3334),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3337),
                        ...
                        new
                        {
                            ...
                            CommentCount = 0,
                            Content = "Yaygın inancın tersine, Lorem Ipsum rastgele sözcüklerden oluşmaz. Kökleri M.Ö. 45 tarihinden bu yana klasik Latin edebiyatına kadar uzanan 2000 yıllık bir geçmişi vardır. Virginia'daki Hampden-Sydney College'dan Latince profesörü Richard McClintock, bir Lorem Ipsum pasajında geçen ve anlaşılması en güç sözcüklerden biri olan 'consectetur' sözcüğünün klasik edebiyattaki örneklerini incelediğinde kesin bir kaynağa ulaşmıştır. Lorm Ipsum, Çiçero tarafından M.Ö. 45 tarihinde kaleme alınan \"de Finibus Bonorum et Malorum\" (İyi ve Kötünün Uç Sınırları) eserinin 1.10.32 ve 1.10.33 sayılı bölümlerinden gelmektedir. Bu kitap, ahlak kuramı üzerine bir tezdir ve Rönesans döneminde çok popüler olmuştur. Lorem Ipsum pasajının ilk satırı olan \"Lorem ipsum dolor sit amet\" 1.10.32 sayılı bölümdeki bir satırdan gelmektedir. 1500'lerden beri kullanılmakta olan standard Lorem Ipsum metinleri ilgilenenler için yeniden üretilmiştir. Çiçero tarafından yazılan 1.10.32 ve 1.10.33 bölümleri de 1914 H. Rackham çevirisinden alınan İngilizce sürümleri eşliğinde özgün biçiminden yeniden üretilmiştir.",
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3343),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3341),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3344),
                            Note = "JAVA",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3350),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3349),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3351),
                            Note = "Python",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3357),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3356),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3358),
                            Note = "PHP",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3367),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3365),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3368),
                            Note = "Kotlin",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3375),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3372),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3376),
                            Note = "Swift",
                            SeoAuthor = "Alper Tunga",
                        ...
                        new
                        {
                            ...
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3402),
                            CreatedByName = "InitialCreate",
                            Date = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3381),
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 79, DateTimeKind.Local).AddTicks(3404),
                            Note = "Ruby",
                            SeoAuthor = "Alper Tunga",
            ...
            modelBuilder.Entity("MyBlog.Entities.Concrete.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6164),
                            CreatedByName = "InitialCreate",
                            Description = "C# Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6179),
                            Name = "C#",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6194),
                            CreatedByName = "InitialCreate",
                            Description = "C++ Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6196),
                            Name = "C++",
                            Note = "C++ Blog Kategorisi"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6201),
                            CreatedByName = "InitialCreate",
                            Description = "JavaScript Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6202),
                            Name = "JavaScript",
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6206),
                            CreatedByName = "InitialCreate",
                            Description = "Typescript Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6208),
                            Name = "Typescript",
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6403),
                            CreatedByName = "InitialCreate",
                            Description = "Java Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6404),
                            Name = "Java",
                        ...
                        {
                            Id = 6,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6409),
                            CreatedByName = "InitialCreate",
                            Description = "Python Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6410),
                            Name = "Python",
                        ...
                        {
                            Id = 7,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6415),
                            CreatedByName = "InitialCreate",
                            Description = "Php Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6416),
                            Name = "Php",
                        ...
                        {
                            Id = 8,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6421),
                            CreatedByName = "InitialCreate",
                            Description = "Kotlin Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6422),
                            Name = "Kotlin",
                        ...
                        {
                            Id = 9,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6426),
                            CreatedByName = "InitialCreate",
                            Description = "Swift Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6428),
                            Name = "Swift",
                        ...
                        {
                            Id = 10,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6432),
                            CreatedByName = "InitialCreate",
                            Description = "Ruby Programlama Dili ile İlgili En Güncel Bilgiler",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 85, DateTimeKind.Local).AddTicks(6434),
                            Name = "Ruby",
            ...
            modelBuilder.Entity("MyBlog.Entities.Concrete.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ArticleId = 1,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6001),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6018),
                        ...
                        new
                        {
                            Id = 2,
                            ArticleId = 2,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6032),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6033),
                            Note = "C++ Makale Yorumu",
                        ...
                        new
                        {
                            Id = 3,
                            ArticleId = 3,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6038),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6039),
                        ...
                        new
                        {
                            Id = 4,
                            ArticleId = 4,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6044),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6046),
                        ...
                        new
                        {
                            Id = 5,
                            ArticleId = 5,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6050),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6052),
                        ...
                        new
                        {
                            Id = 6,
                            ArticleId = 6,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6056),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6057),
                        ...
                        new
                        {
                            Id = 7,
                            ArticleId = 7,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6062),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6063),
                        ...
                        new
                        {
                            Id = 8,
                            ArticleId = 8,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6068),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6069),
                        ...
                        new
                        {
                            Id = 9,
                            ArticleId = 9,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6074),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6075),
                        ...
                        new
                        {
                            Id = 10,
                            ArticleId = 10,
                            CreateDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6080),
                            CreatedByName = "InitialCreate",
                            IsActive = true,
                            IsDeleted = false,
                            ModiefiedByName = "InitialCreate",
                            ModiefiedDate = new DateTime(2021, 7, 31, 17, 6, 39, 89, DateTimeKind.Local).AddTicks(6081),
            ...
            modelBuilder.Entity("MyBlog.Entities.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "bc92d1f0-c55d-47fa-9e66-2f07b3c15c0b",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "175de537-1f82-4ce4-99ea-c2528a6dd93c",
                            Name = "Category.Read",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "6ea6ccf0-91a9-45db-8b1a-326840a5b58a",
                        ...
                        {
                            Id = 4,
                            ConcurrencyStamp = "9407d198-21ad-4eb2-a32d-11d4a226402e",
                        ...
                        {
                            Id = 5,
                            ConcurrencyStamp = "09a27e2b-ca7b-4708-a56c-9b9c18c7504e",
                            Name = "Article.Create",
                        ...
                        {
                            Id = 6,
                            ConcurrencyStamp = "7feeddab-8241-459c-b99a-c349af8b4fcc",
                            Name = "Article.Read",
                        ...
                        {
                            Id = 7,
                            ConcurrencyStamp = "e7632cde-c501-4258-9438-307bea565cc0",
                            Name = "Article.Update",
                        ...
                        {
                            Id = 8,
                            ConcurrencyStamp = "42cd5bb8-1787-4815-88b7-2e7cd2f3d73c",
                            Name = "Article.Delete",
                        ...
                        {
                            Id = 9,
                            ConcurrencyStamp = "d5a7d772-707d-4074-b2cc-16911db3548b",
                            Name = "User.Create",
                        ...
                        {
                            Id = 10,
                            ConcurrencyStamp = "fc454f76-77c0-4ac4-83a8-d74560ac34a7",
                            Name = "User.Read",
                        ...
                        {
                            Id = 11,
                            ConcurrencyStamp = "f688a118-9f37-4383-8241-a923e61b293a",
                            Name = "User.Update",
                        ...
                        {
                            Id = 12,
                            ConcurrencyStamp = "d043792a-d17f-44d3-b110-14ece6644dbc",
                            Name = "User.Delete",
                        ...
                        {
                            Id = 13,
                            ConcurrencyStamp = "587323f8-3d80-4061-84a2-424c40677516",
                            Name = "Role.Create",
                        ...
                        {
                            Id = 14,
                            ConcurrencyStamp = "77dcc44a-5033-465f-a647-3fdedd2cb6d9",
                            Name = "Role.Read",
                        ...
                        {
                            Id = 15,
                            ConcurrencyStamp = "e6a46b61-62ee-47e0-8bf0-c509b3a46d48",
                            Name = "Role.Update",
                        ...
                        {
                            Id = 16,
                            ConcurrencyStamp = "353df2ce-8c71-4705-b782-bde61020addf",
                            Name = "Role.Delete",
                        ...
                        {
                            Id = 17,
                            ConcurrencyStamp = "c7c61cd8-ec73-4064-99c9-7dd03e0ef0c0",
                            Name = "Comment.Create",
                        ...
                        {
                            Id = 18,
                            ConcurrencyStamp = "cef76e06-7a80-48e6-94af-9bac95f6d86f",
                            Name = "Comment.Read",
                        ...
                        {
                            Id = 19,
                            ConcurrencyStamp = "3060d987-7bc8-4ffe-bb45-2adb993edfd2",
                            Name = "Comment.Update",
                        ...
                        {
                            Id = 20,
                            ConcurrencyStamp = "59ad6b12-3c90-485b-9caf-e4cd41ec549f",
                            Name = "Comment.Delete",
                        ...
                        {
                            Id = 21,
                            ConcurrencyStamp = "bae0bfe2-90cb-4195-81a5-bad46b7e95c0",
                        ...
                        {
                            Id = 22,
                            ConcurrencyStamp = "c411792e-6107-4005-a035-500759876081",
                            Name = "SuperAdmin",
            ...
            modelBuilder.Entity("MyBlog.Entities.Concrete.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ad077693-2000-48b9-85ef-afd3f0080e72",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEP8QzAk6JFVrNOpworZedlAK8UNNL6CzLpDx3cRBRu46rTDu40QUugcP9yhKGoe2xA==",
                            PhoneNumber = "+905555555555",
                            PhoneNumberConfirmed = true,
                            Picture = "/userImages/defaultUser.png",
                            SecurityStamp = "b9b4c373-f53d-4d29-a903-2e2dad42f935",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "574b343c-7e6b-4340-8858-de491141c980",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEGJTe3VNfFcimRqmWqqU5XntiVGO/8HIDjmaRXayAhxNFMRmCFuXMG9D6vTUw5D0AA==",
                            PhoneNumber = "+905555555555",
                            PhoneNumberConfirmed = true,
                            Picture = "/userImages/defaultUser.png",
                            SecurityStamp = "37a0c544-cd83-44c3-ae1c-c6a792d2f3ff",
